<div class="dropdown-menu dropdown-menu-sm"  id="context-menu"  >
  ...
  <button id="shareContext"data-toggle="modal" data-target="#share" class="btn btn-link dropdown-item" onclick="clearCreate()" ><i class="fas fa-share-alt-square"></i> {{ __('app.home.contextMenu.share') }}</button>
</div>
