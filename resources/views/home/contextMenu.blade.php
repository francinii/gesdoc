<div class="dropdown-menu dropdown-menu-sm"  id="context-menu"  >
  ...
  <button id="createDocumentContext"  class="btn btn-link dropdown-item" onclick="createDoc(2)" ><i class="fas fa-file-medical"></i> {{ __('app.home.contextMenu.createSheet') }}</button>
