...
<head>
    ...
    <link rel="stylesheet"   href="{{ asset('../resources/extencions/DataTables-1.10.20/css/jquery.dataTables.min.css') }}">
    ...
    <script type="text/javascript"  src="{{ asset('../resources/extencions/DataTables-1.10.20/js/jquery.dataTables.min.js') }}"></script>
    @yield('head')
</head>
